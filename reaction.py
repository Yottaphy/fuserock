...
class Reaction:
    ...
    def _init_(self, E, beamA, beamZ, targA, targZ):
        ...
        self.beamV      = sqrt(2E6*e_charge*self.beamE/(self.targA*u))                                               #beam velocity in m/s
        self.targV      = sqrt(2E6*e_charge*self.targK/(self.targA*u))                                               #scattered target velocity in m/s
    ...
    def Grazing(beamE, beamA, beamZ, targA, targZ):
